...
(function() {
    ...
    DrawingManager.prototype._close = function() {
        ...
        if (this._drawingTool) {
            ...
            var drawingManager = this._drawingTool.drawingManager;
            drawingManager.handlerMask = new Mask({cursor:'pointer'});
            drawingManager._map.addOverlay(drawingManager.handlerMask);
        }
    }
    ...
    function Mask(args){
        ...
        args = args || {};
        this.cursor = args.cursor || 'crosshair';
    }
    ...
    Mask.prototype.initialize = function(map){
        ...
        div.style.cssText = "position:absolute;background:url(about:blank);cursor:" + me.cursor + ";width:" + size.width + "px;height:" + size.height + "px";
    ...
    DrawingTool.prototype._bindEventByDraingMode = function(drawingType){
        ...
        if (drawingType == "hander") {
            ...
            if(drawingManager.handlerMask){
                try{
                    drawingManager._map.removeOverlay(drawingManager.handlerMask);
